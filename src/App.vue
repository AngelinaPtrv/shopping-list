<template>
  <v-app class="app">
    <section class="modify d-flex justify-space-around">
<!--      <v-text-field-->
...
export default {
  ...
  data() {
    return {
      list: [
        {checked: false, name: "Хлеб", quantity: 1, units: "шт"},
        {checked: false, name: "Помидоры", quantity: 2, units: "кг"},
        {checked: false, name: "Огурцы", quantity: 2, units: "кг"},
        {checked: false, name: "Пиво", quantity: 6, units: "бан"},
      ],
      meta: [
